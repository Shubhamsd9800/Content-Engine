...
· `brain/psychology.md` · `work/corrections.md`
...
1. **Append to `work/published.md`** — including `READER` and `RING`. Those two fields are
...
4. If he overrode a flag for a reason, log it in `work/corrections.md`.
