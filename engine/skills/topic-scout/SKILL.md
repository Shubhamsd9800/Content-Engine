...
**Read:** `brain/reference/sources-log.md` · `brain/niche.md` (for the rings)
**Write:** `work/ideas/queue.md` — append to the LIVE table. **Never anywhere else.**
...
`brain/reference/sources-log.md` and his saved collections.
